...
const About = () => {
  ...
  return (
    <div className="about-section-container">
        ...
        <div className="left-column">
          ...
          >
            <a
              ...
              href="https://www.cloudskillsboost.google/public_profiles/8bb4de5d-ffc3-48ba-b434-ad79bde0a1d6"
              target="_blank"
          ...
          <div className="text-content">
            <div className="intro-text">
              <h2 style={{ fontFamily: "Arima, sans-serif" }}>
                <i class="fa-solid fa-pen-nib fa-shake"></i> Hi, I’m Jaya Chandra Sai Kotapati
                👨‍💻ㅤ
              </h2>
      ...
      >
        "This template is made with ❤️ by Jaya Chandra Sai © 2025 💻 (✿◕‿◕✿)"
      </div>
    </div>
  );
};
